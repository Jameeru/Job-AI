...
public class BedrockAIClient {
    ...
    // Claude Sonnet 4.5 — Asia Pacific cross-region inference profile (Mumbai ap-south-1)
    private static final String ACTIVE_MODEL_ID = "ap.anthropic.claude-sonnet-4-5-20250929-v1:0";
